...
<input id="page-id" type="hidden" value="homepage">
...
/*                                $id_do_post = of_get_option('box-segmento1'); // este é o ID do post
        ...
        <section class="secVideo">
            <div class="barra-video">
                ...
                <div class="vimeo">
                    <iframe src="//player.vimeo.com/video/98945042?api=1" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen="true"></iframe>
                </div>
