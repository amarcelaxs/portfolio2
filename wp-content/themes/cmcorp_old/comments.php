...
'fields' => apply_filters( 'comment_form_default_fields', array(
    ...
    'comment_field' => '<div class="form-group"><textarea placeholder="Seu comentário..."  class=" form-control comentarios-info comentarios-commenter-box" type="mensagem" name="comment" aria-required="true"></textarea>' . '</div>',
