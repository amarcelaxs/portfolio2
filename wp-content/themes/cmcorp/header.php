...
<div id="result" style="display:none;"></div>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo esc_url( get_template_directory_uri() ); ?>/vendor/datatables/media/css/jquery.dataTables.css">
				...
				<ul class="nav navbar-nav top-menu">
					...
					<li class="dropdown language">
						...
						<ul class="dropdown-menu change-language">
							...
							<li><a href="?lang=en" ><span class="glyphicon"></span><i class="fa fa-globe" aria-hidden="true"></i>EN</a>															
								<span><?php _e('English','cmcorp')?></span>
							</li>
							<li><a href="?lang=pt" ><span class="glyphicon "></span><i class="fa fa-language" aria-hidden="true"></i>PT</a>
								<span><?php _e('Português','cmcorp')?></span>
							</li>
						</ul>
					</li>
                    <li class="active chat <?php echo $isDiaUtil ? 'diautil' : ''   ?>">
						<a href="#">
