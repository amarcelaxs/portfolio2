...
<section class="secVideoSolucoes">
    <div class="barra-video select-video">
        ...
        <div class="vimeo" style="height: 100%;position: fixed;top: 0;z-index: 2000;">
            <iframe src="https://player.vimeo.com/video/154368107?api=1" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen="true">
            </iframe>
...
<!--<section class="caracteristicas">
    ...
    <div class="container">
        ...
        <div class="row sub-titles">
            <div class="col-md-3" data-scroll-reveal="wait .5s move 0 scale up 2%, over 1s">
                <h2>
                    SISTEMAS
                    <br>
                    MODULARES
