<?php
 ...
 extract($_POST);
   try{
     ...
     $sql = "INSERT INTO contact_form(motivo,nome,empresa,cidade,uf,email,telefone,mensagem) values(:motivo,:contato_nome,:contato_empresa,:contato_cidade,:contato_uf,:contato_email,:contato_telefone,:contato_msg)";	
