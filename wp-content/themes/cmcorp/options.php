...
function optionsframework_options() {
	...
	$options[] = array(
		...
		'id' => 'example_text_mini_meu',
		'std' => 'Default',
		'class' => 'mini',
		'type' => 'text');

	$options[] = array(
		'name' => __('Input Text Mini meu', 'options_check'),
		'desc' => __('A mini text input field. é meu ', 'options_check'),
	...
	$options[] = array(
		'name' => __('Segmentos', 'options_check'),
		'type' => 'heading');



	//SELECTOR PAGE FOR BOX-SEGMENTOS

	$options[] = array(
		'name' => __('Selecione a Página', 'options_check'),
		'desc' => __('Passed an array of pages with ID and post_title', 'options_check'),
		'id' => 'box-segmento1',
		'type' => 'select',
		'options' => $options_pages);
        ...
        $options[] = array(
            'name' => __('Imagem do Segmento', 'options_check'),
            'desc' => __('This creates a full size uploader that previews the image.', 'options_check'),
            'id' => 'background1',
            'type' => 'upload');
			...
			foreach ( $pages as $page ) {
				$option = '<option value="' . get_pages($pages) . '">';
				$option .= $page->post_title;
				$option .= '</option>';
			}*/

            //Aba para links de redes sociais
          
            $options[] = array(
                'name' => __('Redes Sociais', 'options_check'),
                'type' => 'heading');

            $options[] = array(
            'name' => __('Icone do Facebook ', 'options_check'),
            'desc' => __('This creates a full size uploader that previews the image.', 'options_check'),
            'id' => 'icon_facebook',
            'type' => 'upload');
            
            $options[] = array(
                'name' => __('Página do Facebook', 'options_check'),
                'desc' => __('A text input field.', 'options_check'),
                'id' => 'facebook',
                'std' => '',
                'type' => 'text');
           ...
           $options[] = array(
            'name' => __('Icone do Linkedin ', 'options_check'),
            'desc' => __('This creates a full size uploader that previews the image.', 'options_check'),
            'id' => 'icon_linkedin',
            'type' => 'upload');
            
            $options[] = array(
                'name' => __('Página do Linkedin', 'options_check'),
                'desc' => __('A text input field.', 'options_check'),
                'id' => 'linkedin',
                'std' => '',
                'type' => 'text');
            ...
            $options[] = array(
            'name' => __('Icone do Vimeo ', 'options_check'),
            'desc' => __('This creates a full size uploader that previews the image.', 'options_check'),
            'id' => 'icon_vimeo',
            'type' => 'upload');
                
             $options[] = array(
                'name' => __('Página do Vimeo', 'options_check'),
                'desc' => __('A text input field.', 'options_check'),
                'id' => 'vimeo',
                'std' => '',
                'type' => 'text');               
            ...
            $options[] = array(
            'name' => __('Icone do Youtube', 'options_check'),
            'desc' => __('This creates a full size uploader that previews the image.', 'options_check'),
            'id' => 'icon_youtube',
            'type' => 'upload');
              
             $options[] = array(
                'name' => __('Página do Youtube', 'options_check'),
                'desc' => __('A text input field.', 'options_check'),
                'id' => 'youtube',
                'std' => '',
                'type' => 'text');
