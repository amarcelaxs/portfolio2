...
<div id="primary" class="content-area">
    ...
    <div class="row"-->
        <section id="banner-top-prev">
                  <div class="container-fluid">
                      <div class="plx"  data-top-top="margin-top: 0%;" data-center-top="margin-top: -9%;"  style="background-image:url('<?php conteudo_page($idsegmento);?>') ">
                        <div class="row">
                            <div class="col-md-6 col-md-push-3">
                                <h2 data-top-top="opacity: 0; margin-top: 6%;" data-center-top="opacity: 1; margin-top: 0%;">  <?php the_title(); ?></h2>
                            </div>
                        </div>
                       </div>
                   </div>
