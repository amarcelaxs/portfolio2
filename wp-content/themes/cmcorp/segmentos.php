...
<div id="primary" class="content-area">
    ...
    <div class="row"-->
        ...
        <section id="banner-top-prev" class="col-xs-12 no-padding">
            ...
            <div class="container">
                ...
                <div class="row  ">
                    <?php
					   ...
					   quadradinhos($parent_id,$idsegmento);      
                    ?>
                </div>
            </div>
        </section>
        ...
        <section id="contacte">
            <div class="container">
                <div class="row">
                    ...
                    <a href="/contato" class=" action-bt">ENTRE EM CONTATO</a>
                </div>
            </div>
        </section>
        <!--End Contacte-nos-->
