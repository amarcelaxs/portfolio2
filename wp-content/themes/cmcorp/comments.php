...
<?php if ( have_comments() ) : ?>
	<div class="pra-direita">
		<h6 class="quantos"><?php
				...
				printf( _nx( '1 comentário', '%1$s comentários', get_comments_number(), 'comments title', 'cmcorp' ),
...
comment_form($comment_args); ?>
	...
	<?php if ( have_comments() ) : ?>
		...
		<nav id="comment-nav-above" class="comment-navigation" role="navigation">
			...
			<h2 class="screen-reader-text"><?php _e( 'Comment navigation', 'cmcorp' ); ?></h2>

			<div class="nav-previous"><?php previous_comments_link( __( '&larr; Older Comments', 'cmcorp' ) ); ?></div>

			<div class="nav-next"><?php next_comments_link( __( 'Newer Comments &rarr;', 'cmcorp' ) ); ?></div>
	...
	?>
			<p class="no-comments"><?php _e( 'Comments are closed.', 'cmcorp' ); ?></p>
