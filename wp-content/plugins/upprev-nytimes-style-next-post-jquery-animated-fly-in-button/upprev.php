...
Version: 3.3.30
Author: Jason Pelker, Grzegorz Krzyminski, Marcin Pietrzak
...
Copyright 2011-2015 Jason Pelker (jason@item-9.com)
 ...
 * static options
 */
define( 'IWORKS_UPPREV_VERSION', '3.3.30' );
...
function iworks_upprev_plugin_links ( $links, $file )
{
    if ( $file == plugin_basename(__FILE__) ) {
        ...
        $links[] = '<a href="http://item-9.com">' . __('Need Marketing Help?') . '</a>';
    }
    return $links;
}
